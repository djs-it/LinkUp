...
---------------------------
--获取自我的显示字符串
--@function [parent=#ByteArray] toString
--@param self
--@param number#number __radix ?进制,radix of display, value is 8, 10 or 16, default is 10.
...
function ByteArray:ctor(__endian)
	...
	self._buf = {}
	self._pos = 1
    self.setEndian(self,ByteArray.ENDIAN_BIG)
end
...
---------------------------
--
--@function [parent=#ByteArray] reset
--@param self
