...
void ShatterSprite::startShatter(float time){
    shatter::CshatterAction*shatter=shatter::CshatterAction::create(time);
    this->runAction(shatter);
}
...
ShatterSprite* ShatterSprite::create(const char* $pszFileName)
{
    ShatterSprite *pobSprite = new ShatterSprite();
...
ShatterSprite* ShatterSprite::create(const char* $pszFileName, const Rect& $rect)
{
    ShatterSprite *pobSprite = new ShatterSprite();
...
ShatterSprite* ShatterSprite::createWithSpriteFrame(SpriteFrame* $pSpriteFrame)
{
    ShatterSprite *pobSprite = new ShatterSprite();
...
ShatterSprite* ShatterSprite::createWithSpriteFrameName(const char* $pszSpriteFrameName)
{
