...
bool GhostSprite::init(CCSpriteFrame* spriteFrame,float filterR,float fliterSrcScale){
    //----create sprite
...
bool GhostSprite::init(const string&texFileName,float filterR,float fliterSrcScale)
{
    //----create sprite
...
bool GhostSprite::init(CCSprite* sprite,float filterR,float fliterSrcScale){
...
void GhostSprite::visit(Renderer* renderer, const Mat4 &parentTransform, uint32_t parentFlags)
{
    ...
    //----draw m_biggerRT to m_filterXRT (use m_program_fliterX)
    {
        ...
        _biggerRTpassUnifoAndBindTexCommand.func = CC_CALLBACK_0(GhostSprite::onBiggerRTPassUnifoAndBindTex, this,_modelViewTransform,flags);
    ...
    //----draw m_filterXRT to m_filterYRT (use m_program_fliterY)
    {
        ...
        _filterXRTpassUnifoAndBindTexCommand.func = CC_CALLBACK_0(GhostSprite::onFilterXRTPassUnifoAndBindTex, this,_modelViewTransform,flags);
...
void GhostSprite::onBiggerRTPassUnifoAndBindTex(const Mat4 &transform, uint32_t flags){
...
void GhostSprite::onFilterXRTPassUnifoAndBindTex(const Mat4 &transform, uint32_t flags){
...
GhostSprite* GhostSprite::create(const char* $pszFileName)
{
    GhostSprite *pobSprite = new GhostSprite();
    if (pobSprite)
    {
