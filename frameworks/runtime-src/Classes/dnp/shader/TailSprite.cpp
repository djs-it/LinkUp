...
void TailSprite::draw(Renderer* renderer, const Mat4 &transform, uint32_t flags){
    
        _customCommand.init(_globalZOrder);
        _customCommand.func = CC_CALLBACK_0(TailSprite::onDraw,this,transform, flags);
        renderer->addCommand(&_customCommand);
    if(m_isDrawDebug){
        
        _customCommand_debug.init(_globalZOrder);
        _customCommand_debug.func = CC_CALLBACK_0(TailSprite::onDrawDebug,this,transform, flags);
        renderer->addCommand(&_customCommand_debug);
    }
}

void TailSprite::onDrawDebug(const Mat4 &transform, uint32_t flags){
...
void TailSprite::onDraw(const Mat4 &transform, uint32_t flags)
{
...
void TailSprite::update(float dt){
    //add a pos
...
Cmesh* TailSprite::generateMesh(const vector<CfootPrint>&footPrintList){
...
TailSprite* TailSprite::create(const char* $pszFileName)
{
    TailSprite *pobSprite = new TailSprite();
...
TailSprite* TailSprite::create(const char* $pszFileName, const Rect& $rect)
{
    TailSprite *pobSprite = new TailSprite();
...
TailSprite* TailSprite::createWithSpriteFrame(SpriteFrame* $pSpriteFrame)
{
    TailSprite *pobSprite = new TailSprite();
...
TailSprite* TailSprite::createWithSpriteFrameName(const char* $pszSpriteFrameName)
{
