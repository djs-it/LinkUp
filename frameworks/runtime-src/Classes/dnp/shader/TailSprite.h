...
class TailSprite : public Sprite
{
public:
	TailSprite() {
        m_dt=0.1;
    ...
    static TailSprite* create(const char* $pszFileName);
    static TailSprite* create(const char* $pszFileName, const Rect& $rect);
    static TailSprite* createWithSpriteFrame(SpriteFrame* $pSpriteFrame);
    static TailSprite* createWithSpriteFrameName(const char* $pszSpriteFrameName);
protected:
